...
public class EjemplaresController {
	...
	@Autowired
	@Qualifier("ejemplarValidator")//extension del autowired para que busque el id del bean
	...
	public ModelAndView getAll(){
		mav=new ModelAndView("/ejemplares/listado_rest");
	...
	@RequestMapping(value="/addEjemplar", method=RequestMethod.GET)//el methodrequest no hace falta ponerlo, en este caso
	...
	public String saveEjemplar(@ModelAttribute("ejemplar") @Validated(Ejemplar.class) Ejemplar ejemplar, BindingResult bindingResult){//en el modelAtt, el mismo nombre que 
