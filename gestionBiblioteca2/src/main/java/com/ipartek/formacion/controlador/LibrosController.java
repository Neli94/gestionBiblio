...
public class LibrosController {
	...
	@Autowired
	@Qualifier("libroValidator")//extension del autowired para que busque el id del bean
	...
	public ModelAndView getAll(){
		mav=new ModelAndView("/libros/listado_rest");
	...
	@RequestMapping(value="/addLibro", method=RequestMethod.GET)//el methodrequest no hace falta ponerlo, en este caso
	...
	public String saveLibro(@ModelAttribute("libro") @Validated(Libro.class) Libro libro, BindingResult bindingResult){//en el modelAtt, el mismo nombre que 
