...
public class UsuariosController {
	 ...
	 * @Autowired
	 * 
	 * @Qualifier("usuarioValidator") // extension del autowired para que busque
	...
	@RequestMapping(value = "/addUsuario", method = RequestMethod.GET) // el
																		// methodrequest
																		// no
																		// hace
																		// falta
	...
	public String saveUsuario(@ModelAttribute("usuario") @Validated(Usuario.class) Usuario usuario,
